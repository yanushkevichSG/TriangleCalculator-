...
import com.epam.triangle.comprator.ComparatorByXCordinate;
...
public class ComparatorByXCordinateTest {
    private static final Comparator<Triangle> comparator = new ComparatorByXCordinate(0);
